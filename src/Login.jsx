...
const googleLogin = useGoogleLogin({
  onSuccess: async (tokenResponse) => {
    try {
      const res = await fetch('http://localhost:5000/api/auth/seller/google/login', {
        method: 'POST',
    ...
    <div className="lp-wrapper">
      <div className="lp-card">
        ...
        <div className="lp-socials">
          <div className="lp-socials">
        <button className="lp-social-btn" type="button" onClick={() => googleLogin()}>
          <GoogleIcon />
        ...
        <p className="lp-signup">
          لا يوجد عندك حساب؟ <a href="/register">إنشاء حساب</a>
        </p>
