const btnStyle = {
 width: '100%', // تغيير العرض ليكون كامل
  height: 48,
  ...
  padding: '0 16px', // إضافة حشوة جانبية
  fontSize: '14px',
  fontWeight: '500',
  color: '#374151'
}
...
export default function OAuthButtons({ onGoogle }) {
  return (
    <div style={{ display: 'flex', justifyContent: 'center', gap: 14, marginBottom: '1.25rem' }}>
      <button type="button" style={btnStyle} onClick={onGoogle} aria-label="Google"
        onMouseEnter={e => e.currentTarget.style.boxShadow = '0 2px 8px rgba(0,0,0,.1)'}
        onMouseLeave={e => e.currentTarget.style.boxShadow = 'none'}>
        <svg viewBoxz="0 0 24 24" width="22" height="22">
