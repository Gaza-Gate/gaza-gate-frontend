 ...
 * بنفس تنسيق FormCard/CardHeader المستخدم بـ VerifyEmail.jsx
 * مع الحفاظ على نفس وظيفة صناديق الكود الست وعداد إعادة الإرسال.
 *
...
export default function VerifyOTP() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      navigate('/home/customer', { state: { verified: true } })
    } catch (err) {
      setApiError(err.message)
    } finally {
      setLoading(false)
