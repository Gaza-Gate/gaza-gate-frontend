    ...
    <div className="sp-root" dir="rtl">
      ...
      <nav className="sp-navbar">
        <div className="sp-nav-logo">
          <img src={logo} alt="Gaza Gate" className="sp-logo-img" />
        </div>
        <div className="sp-nav-links">
          <a href="#" className="sp-nav-link">
          ...
          <a href="#" className="sp-nav-link sp-nav-active">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="sp-nav-left">
          <button className="sp-btn-notif">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
              <path d="M13.73 21a2 2 0 0 1-3.46 0" />
            </svg>
            <span className="sp-notif-dot"></span>
          </button>
          <button className="sp-btn-logout" onClick={() => navigate("/login")}>
            <span>خروج</span>
