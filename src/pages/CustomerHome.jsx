...
// ── أيقونات الأقسام (بسيطة SVG لتفادي الاعتماد على صور خارجية) ──
const HandcraftIcon = () => (
...
const howItWorks = [
  ...
  { Icon: User, title: "ادفع بأمان", desc: "ادفع بطريقتك المفضلة بأمان تام" },
    ...
    <div className="home-wrapper" dir="rtl">
      ...
      <nav className="home-nav">
        <div className="home-nav-side">
          <button className="home-icon-btn" aria-label="خروج">
            <LogOut size={18} />
            <span>خروج</span>
          </button>
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-deco">
          <ShoppingCart size={150} strokeWidth={1} className="home-hero-cart" />
        </div>

        <div className="home-hero-content">
          <span className="home-hero-pill">مرحبا {userName}, عروض اليوم تصل حتى خصم40%</span>
      ...
      <section className="home-section">
        <div className="home-banners">
          ...
          <div className="home-banner home-banner--orange">
            ...
            <span className="home-banner-eyebrow home-banner-eyebrow--light">عروض الإلكترونيات</span>
            <h3>خصم حتى 30%</h3>
